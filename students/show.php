...
<div class="card">
    ...
    <div class="info">
        ...
        <span class="value"><?php echo $student['first_name']; ?></span>
    </div>

    <div class="info">
        <span class="label">Familiyasi:</span>
        <span class="value"><?php echo $student['last_name']; ?></span>
    </div>
    ...
    <div class="info">
        <span class="label">Sinfi:</span>
        <span class="value"><?php echo $student['class_name']; ?></span>
    </div>
